import type { SidebarItem, StatCard, QueueItem, DeptUtilization, Appointment } from "../features/admin/types/dashboard.types"
...
export const QUEUE_DATA: QueueItem[] = [
  { id: 'Q-104', name: 'John Doe', dept: 'Cardiology', doctor: 'Dr. Sarah Jenkins', priority: true },
  { id: 'Q-105', name: 'Maria Silva', dept: 'General', doctor: 'Dr. Alan Rick', priority: false },
  { id: 'Q-106', name: 'Robert King', dept: 'Orthopedics', doctor: 'Dr. Lisa Wong', priority: false }
];
...
export const RECENT_APPOINTMENTS: Appointment[] = [
  { id: 1, patient: 'Alice Walker', doctor: 'Dr. Emily Smith', time: '09:30 AM', status: 'Confirmed' },
  { id: 2, patient: 'Tom Brown', doctor: 'Dr. Michael Chen', time: '10:15 AM', status: 'In Progress' },
  { id: 3, patient: 'Sarah Miller', doctor: 'Dr. Sarah Jenkins', time: '11:00 AM', status: 'Waiting' }
];