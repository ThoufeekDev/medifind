...
} from '../../validators/createDoctor.schema';
  ...
  return (
    <div className="modal-overlay" onClick={handleBackdropClick} role="dialog" aria-modal="true">
      <div className="modal-card">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="modal-scroll-form" noValidate>
          {/* NAME */}
          ...
          <div className="modal-field-split">
            <div className="modal-form-group">
              <label htmlFor="qualification">Qualification Credentials</label>
          ...
          <div className="modal-field-split">
            <div className="modal-form-group">
              ...
              <FormError message={errors.consultationFee?.message} />
            </div>
            ...
            <div className="modal-form-group">
              ...
              <div className="modal-input-wrapper">
                <select id="specialization" {...register('specializationId')}>
              ...
              <FormError message={errors.specializationId?.message} />
            </div>
          </div>

          {/* BIO */}
          <div className="modal-form-group">
            <label htmlFor="bio">Professional Statement / Bio</label>
          ...
          {/* IMAGE */}
          <div className="modal-form-group">
            <label htmlFor="doctor-image">Profile Image (Optional)</label>

            <div className="modal-input-wrapper">
              <input id="doctor-image" type="file" accept="image/*" {...register('image')} />
            </div>
          </div>
